...
export const navLinks: NavItem[] = [
  ...
  { label: "კურსი", href: "/codeSchoolCourses" },
  {
    label: "ლექსიკონი",
...
export const projectsData = [
  {
    ...
    role: "პროექტის მენეჯერი და პროფესიული აკსელერაციის მენეჯერი",
    socials: [
      {
        id: "linkedin",
        icon: "/images/svg/linkdin.svg",
        link: "https://www.linkedin.com/in/tamara-gigineishvili-8254b024a/",
      },
    ],
  },
  {
  ...
  {
    id: 3,
    name: "თამუნა ზურაბიშვილი",
    role: "პროექტის მენეჯერი",
    socials: [
      {
        id: "linkedin",
        icon: "/images/svg/linkdin.svg",
        link: "https://www.linkedin.com/in/tamuna-zurabashvili/",
      },
    ],
  },
  {
    id: 4,
    name: "თორნიკე რობაქიძე",
    role: "ინტერფეისის დიზაინერი",
    socials: [
      {
        id: "linkedin",
        icon: "/images/svg/linkdin.svg",
        link: "https://www.linkedin.com/in/tornike-robakidze/",
      },
    ],
  },
  // // programmers - add actual names as needed
  // {
  //   id: 5,
  //   name: "ანდრო ქავჟარაძე",
  //   role: "პროგრამისტი",
  //   socials: [{ id: "github", icon: "/images/svg/github.svg", link: "#" }],
  // },
  // {
  //   id: 6,
  //   name: "ნინო საჯაია",
